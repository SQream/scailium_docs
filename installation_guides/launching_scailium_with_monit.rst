.. _launching_scailium_with_monit:

*********************************************
Launching SCAILIUM with Monit
*********************************************

This procedure describes how to launch SCAILIUM using Monit. 

Launching SCAILIUM
====================================  

After doing the following, you can launch SCAILIUM according to the instructions on this page. 



1. :ref:`Installing Monit <installing_monit>`
2. :ref:`Installing SCAILIUM with Binary <installing_scailium_with_binary>`
...
* :ref:`Stopping Monit and SCAILIUM separately <stopping_monit_and_sqream_separately>`
* :ref:`Stopping SCAILIUM using a Monit command <stopping_sqream_using_a_monit_command>`

.. _stopping_monit_and_sqream_separately: 

Stopping Monit and SCAILIUM Separately
-------------------------------------

You can stop the Monit service and SCAILIUM separately as follows:
...
Restarting Monit automatically restarts the SCAILIUM services. 

.. _stopping_sqream_using_a_monit_command:    

Stopping SCAILIUM Using a Monit Command
-------------------------------------

You can stop SCAILIUM using a Monit command as follows:

.. code-block:: console
     
   $ sudo monit stop sqream3

This command stops SCAILIUM only (and not Monit).

You can restart SCAILIUM as follows:
...
Using Monit While Upgrading Your Version of SCAILIUM
==================================================

While upgrading your version of SCAILIUM, you can use Monit to avoid conflicts (such as service start). This is done by pausing or stopping all running services while you manually upgrade SCAILIUM. When you finish successfully upgrading SCAILIUM, you can use Monit to restart all SCAILIUM services

**To use Monit while upgrading your version of SCAILIUM:**
...
4. Restart the SCAILIUM services:
